...
const sizeList = [16, 20, 24, 32] as const;

const iconList = [
  'archive__line',
  'arrow-right-left__line',
  'book-open-check__line',
  'bot-message-square__fill',
  'bot-message-square__line',
  'calendar__line',
  'check__line',
  'chevron-down__line',
  'chevron-left__line',
  ...
  'chevron-up__line',
  'chevrons-left__line',
  'chevrons-right__line',
  'chevrons-up-down__line',
  'circle-alert__fill',
  'circle-alert__line',
  'circle-arrow-left__line',
  'circle-arrow-right__line',
  'circle-check__fill',
  'circle-check__line',
  'circle-question-mark__fill',
  'circle-question-mark__line',
  'circle-user-round__line',
  'circle-x__fill',
  'circle-x__line',
  'cloud-upload__line',
  'component__line',
  'copy__line',
  'custom-ellipsis-small__line',
  'custom-empty__line',
  'custom-home__fill',
  'custom-light__line',
  'custom-save-exit__line',
  'custom-x-large__line',
  'custom-x-small__line',
  'download__line',
  'ellipsis-vertical__line',
  'ellipsis__line',
  'eye-off__line',
  'eye__line',
  'file-chart-column__line',
  'file-input__line',
  'file-output__line',
  'file-pen-line__line',
  'gamepad-2__line',
  ...
  'info__line',
  'layers-plus__line',
  'layout-template__line',
  'link-2__line',
  'list-indent-increase__line',
  'list-plus__line',
  'log-in__line',
  'log-out__line',
  'mail__line',
  'message-circle-more__fill',
  'message-circle-more__line',
  'message-circle-plus__line',
  'minus__line',
  'mouse-pointer-click__line',
  'move__line',
  'panel-left-close__line',
  'panel-left-open__line',
  'pencil-line__line',
  'play__line',
  'plus__line',
  'redo-2__line',
  ...
  'share__line',
  'shield-check__line',
  'sliders-horizontal__line',
  'spline-pointer__line',
  'square-arrow-out-up-right__line',
  'square-pen__line',
  'star__fill',
  'star__line',
  'thumbs-down__fill',
  ...
  'thumbs-up__line',
  'trash-2__line',
  'triangle-alert__fill',
  'triangle-alert__line',
  'undo-2__line',
  'user__fill',
  'user__line',
  'vector-square__line',
