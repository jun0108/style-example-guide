...
<template>
  <v-radio :options="codes" label-key="cdNm" value-key="cdId" />
</template>
```
...
```vue
<template>
  <v-radio :options="codes" label="이름" />
</template>
```
...
```vue
<template>
  <v-radio :options="codes" desc="데이터를 선택해 주세요" />
</template>
```
...
```vue
<template>
  <v-radio :options="codes" disabled />
</template>
```
...
```vue
<template>
  <v-radio :options="codes" required />
</template>
```
...
```vue
<template>
  <v-radio :options="codes" required required-msg="값을 입력해 주세요" />
</template>
```
